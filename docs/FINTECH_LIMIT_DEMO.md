...
```text
Increase customer limit from €5,000 to €8,000.
```
...
```text
Increase customer limit from €5,000 to €7,000.
```
...
Recommendation: increase limit to €8,000
...
-----------------------------------------------
AI action: recommend_limit_change
Recommendation: increase limit to €7,000
Functional status: PASS
Causal status: PASS
Verdict: PROCEED
