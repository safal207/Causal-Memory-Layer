...
def resolve_fixture_path(path: Path) -> Path:
    ...
    - Full repo-relative path (e.g., 'benchmarks/experimental/07_*.json'): resolved under base dir
    ...
    # Always build candidate from trusted base_dir; never resolve untrusted path directly.
