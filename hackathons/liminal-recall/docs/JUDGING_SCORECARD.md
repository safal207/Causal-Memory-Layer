...
- focused tests cover embedding request shape, retrieval mode, authentication, causal linkage, and fail-closed behavior;
- protected repository CI includes semantic retrieval, causal linkage, and Titan embedding contracts.
